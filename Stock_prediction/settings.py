...
SECRET_KEY = 'django-insecure-lwhw5ftw2)+g!a8-7%^tvm++*o8lvp@n)8w$0z25=*^9^gi%kk'
...
# Add these lines at the END of your Stock_prediction/settings.py file
...
STATIC_URL = '/static/'  # This MUST be set
...
LOGIN_REDIRECT_URL = 'predictor:index'
